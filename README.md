...
### Cameras
- ✅ **Camera** - WebRTC live view in the SinricPro portal and app, with remote resolution, frame rate and flash control, plus snapshot upload. H.264 video track on ESP32-S3, JPEG over the DataChannel elsewhere (example needs ESP-IDF 5.5+)
